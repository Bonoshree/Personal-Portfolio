...
export function Hero() {
  ...
  const handleViewCV = () => {
    ...
    window.open("/bonoshree-cv.pdf", "_blank", "noopener,noreferrer");
  };
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center text-center lg:text-left">
          <div className="space-y-6">
            ...
            <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Bridging circuits and code to create intelligent and connected solutions.  
              Passionate about Machine Learning and Embedded Systems.
            </p>
